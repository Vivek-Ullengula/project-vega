...
export function ChatInput({
  ...
  return (
    <div className="z-10 flex shrink-0 flex-col border-t border-neutral-200 bg-white shadow-[0_-4px_12px_rgba(0,0,0,0.06)]">
      <form
        className="flex items-end gap-2 px-4 pt-3 pb-2"
      ...
      <div className="px-4 pb-3 text-center text-xs text-neutral-500">
        AI-assisted responses are generated from{" "}
        <span className="cursor-default underline underline-offset-2">
          Coaction-approved binding authority materials
        </span>{" "}
        and require{" "}
        <span className="cursor-default underline underline-offset-2">
